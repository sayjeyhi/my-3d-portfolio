...
export const PlayerFire = ({ hitAudioRef }) => {
  ...
  const content = (
    <div className="relative">
      <img src={ARROW_FLYING} className="absolute top-[60px] " alt="player-fire" />
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-6 h-6 text-blue-600 absolute top-[40px] left-[30px]"
        viewBox="0 0 24 24">
        <path
          fill="#251500"
