...
export const icons = {
  ...
  experience: (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" viewBox="0 0 24 24">
      <path fill="currentColor" d="M4 8h16v11H4z" opacity=".3" />
      <path
        fill="currentColor"
  ...
  Armenia: (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 64 64">
      <path fill="#0033a0" d="M0 26h64v14H0z" />
      <path fill="#d90012" d="M54 11H10C3.373 11 0 15.925 0 22v4h64v-4c0-6.075-3.373-11-10-11" />
      <path fill="#f2a800" d="M0 44c0 6.075 3.373 11 10 11h44c6.627 0 10-4.925 10-11v-4H0v4" />
    </svg>
  ),
  Iran: (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 64 64">
      <path fill="#e6e7e8" d="M0 25h64v14H0z" />
      <path fill="#29b473" d="M54 10H10C3.373 10 0 14.925 0 21v4h64v-4c0-6.075-3.373-11-10-11" />
      <path fill="#ec1c24" d="M0 43c0 6.075 3.373 11 10 11h44c6.627 0 10-4.925 10-11v-4H0v4" />
      <g fill="#c32129" fillRule="evenodd">
        <path d="M29.436 27.2c-.013.01-.022.018-.029.02c-.672.38-1.197.908-1.619 1.548a6.269 6.269 0 0 0-.9 2.245a7.185 7.185 0 0 0-.125 1.657c.047 1.072.311 2.083.845 3.02a5.085 5.085 0 0 0 .497.73c-.208-.045-1.025-.74-1.359-1.151a5.034 5.034 0 0 1-1.133-3.32c.069-2.438 1.807-4.282 3.823-4.75m1.015-1.482c.052.379.318.681.668.756c.338.074.703-.075.904-.445c.207.343.499.526.9.443c.395-.081.598-.362.686-.744c.005.054.018.105.02.156c.016.321-.061.612-.264.865c-.177.217-.402.342-.688.335a.834.834 0 0 1-.597-.289l-.053-.057c-.061.057-.117.12-.181.169c-.37.289-.874.219-1.167-.164c-.229-.296-.297-.634-.243-.998c0-.006.005-.013.005-.018a.058.058 0 0 0 .01-.009m4.162 1.483c.015.01.024.018.031.02c.672.38 1.197.908 1.619 1.548c.45.688.739 1.439.898 2.245c.107.546.149 1.099.125 1.657c-.045 1.072-.309 2.083-.842 3.02a5.091 5.091 0 0 1-.471.693c-.008.01-.02.024-.027.037c.209-.045 1.026-.74 1.359-1.151c.379-.468.668-.983.864-1.554a5.094 5.094 0 0 0 .269-1.766c-.067-2.438-1.807-4.282-3.825-4.75" />
        <path d="M36.01 33.541a5.838 5.838 0 0 0-.117-3.628a5.686 5.686 0 0 0-1.819-2.565l.02.034a6.236 6.236 0 0 1 1.01 2.505c.08.481.11.969.08 1.456c-.082 1.413-.543 2.684-1.42 3.8c-.298.379-.641.72-1.021 1.019c-.013.007-.024.017-.044.032c.054-2.867.105-5.723.159-8.579c-.353-.101-.609-.328-.835-.607c-.228.279-.482.507-.835.607c.054 2.856.105 5.712.159 8.579c-.02-.016-.031-.025-.044-.032a6.04 6.04 0 0 1-1.021-1.019c-.877-1.116-1.337-2.387-1.423-3.8c-.029-.487 0-.975.083-1.456a6.208 6.208 0 0 1 1.01-2.505l.021-.034a5.678 5.678 0 0 0-1.82 2.565a5.845 5.845 0 0 0-.117 3.628c.463 1.597 1.439 2.787 2.904 3.577c-.5.169-1.391.348-2.422.187c.008.002.015.007.021.01c.524.215 1.07.343 1.637.387c.4.031.803.02 1.201-.039c.037-.005.055.005.074.034c.181.289.364.575.545.864c.01.012.018.024.027.039l.027-.039c.181-.289.365-.575.546-.864c.02-.029.036-.039.073-.034c.398.059.801.07 1.202.039a5.397 5.397 0 0 0 1.636-.387l.02-.01a5.251 5.251 0 0 1-2.419-.187c1.464-.79 2.444-1.98 2.904-3.577" />
      </g>
    </svg>
  ),
  Netherlands: (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 64 64">
      ...
      <path fill="#1b75bb" d="M0 43c0 6.075 3.373 11 10 11h44c6.627 0 10-4.925 10-11v-4H0v4" />
    </svg>
  ),
  default: (
    <svg
